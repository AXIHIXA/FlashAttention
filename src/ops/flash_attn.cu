...
#include "ops/flash_attn.h"

#include "flash_attn/fmha.h"
#include "flash_attn/static_switch.h"


Launch_params <FMHA_fprop_params>
set_fmha_fwd_params(void * q, void * k, void * v, void * o, int * cu_seq_q, int * cu_seq_k,
...
void flash_attn(void * q, void * k, void * v, void * o,
                int * cu_seq_q, int * cu_seq_k, size_t total_q, size_t max_seq_q, size_t max_seq_k,
                size_t batch, size_t head_q, size_t head_k, size_t dim,
                bool is_causal, int num_splits, bool is_alibi,
                cudaStream_t stream, cudaDeviceProp * dev_prop)
{
    static Launch_params <FMHA_fprop_params> launch_params =
            set_fmha_fwd_params(q, k, v, o, cu_seq_q, cu_seq_k, total_q, max_seq_q, max_seq_k, batch, head_q, head_k,
                                dim,
