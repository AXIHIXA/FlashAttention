...
static constexpr float kLog2e = 1.4426950408889634074f;  // log_2 e

Flash_fwd_params
set_mha_fwd_params(void * q, void * k, void * v, void * o, int * cu_seq_q, int * cu_seq_k, size_t max_seq_q,
                   ...
                   bool is_causal, bool is_alibi, cudaDeviceProp * dev_prop)
{
    ...
    params.scale_softmax_log2 = params.scale_softmax * kLog2e;
...
void flash_attn_v2(void * q, void * k, void * v, void * o,
