...
public:
    ...
    explicit Tester(size_t batch = 2,
                    size_t seq_q = 256,
                    size_t seq_k = 256,
                    size_t head_q = 32,
                    size_t head_k = 32,
                    ...
                    size_t prefill_fraction = 0,
                    cudaStream_t stream = nullptr,
                    cudaDeviceProp * dev_prop = nullptr,
                    size_t warmup_iterations = 1,
                    size_t profiling_iterations = 10,
                    size_t sleep_duration = 100,
...
private:
    ...
    std::shared_ptr<Tensor<half>> m_base = nullptr;  // total_q * head_q * dim, base result, init tensor O before each fmha
